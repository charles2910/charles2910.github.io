...
As soon as Gnome made the dark theme available I changed to it - after a quick
research: it was released in Gnome 42 in March 2022. Back then I was at
university and spent most of the time in the classroom with a pencil and a
notebook (a paper one :-) and only a few hours on my laptop, so the dark theme
was very nice.

Let’s jump to the present day where I work full time with my computer and a lot
of my free time goes to Debian. After I leave my $dayjob, my eyes are pretty
much done, they are dry (working in AC all day doesn’t help either), it is
difficult to focus on text and I am very tired in general. I remember reading
...
example). The worst thing is all predefined color schemes had this problem and
...
earth I'm blindly executing a script from the internet on my laptop - well, it
...
written on the page showing the color schemes available. All I had to do was
...
It all worked beautifully and I have a great color scheme! Yeah, I wish, the
background color of neomutt became a terrible gray that made everything
terrible to read.

![neomutt catppucino theme]({{ '/assets/img/posts/2024-12/neomut-catppucino.png' |
relative_url }}){: .mx-auto.d-block :}

The solution was to grab the color from the Gnome color scheme for that
specific one and voilà:
